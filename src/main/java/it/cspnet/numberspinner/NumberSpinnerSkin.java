 ...
 * http://myjavafx.blogspot.it/2013/05/developing-numberspinner-control.html
 */
public class NumberSpinnerSkin extends StackPane implements Skin<NumberSpinner> {
    ...
    public NumberSpinnerSkin(final NumberSpinner numberSpinner) {
        ...
        textField.focusedProperty().addListener((ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean aBoolean1) -> {
...
//                    }
        ...
        changeListenerSelection = (ObservableValue<? extends IndexRange> observableValue, IndexRange indexRange, IndexRange indexRange2) -> {
        ...
        textField.selectionProperty().addListener((ObservableValue<? extends IndexRange> observableValue, IndexRange indexRange, IndexRange indexRange1) -> {
        ...
        changeListenerCaretPosition = (ObservableValue<? extends Number> observableValue, Number number, Number number1) -> {
            textField.positionCaret(number1.intValue());
        };
        numberSpinner.caretPositionProperty().addListener(changeListenerCaretPosition);

        textField.caretPositionProperty().addListener((ObservableValue<? extends Number> observableValue, Number number, Number number1) -> {
        ...
        changeListenerValue = (ObservableValue<? extends Number> observableValue, Number number, Number number2) -> {
            setText();
        };
        numberSpinner.valueProperty().addListener(changeListenerValue);
        changeListenerHAlignment = (ObservableValue<? extends HPos> observableValue, HPos hPos, HPos hPos1) -> {
        ...
        btnIncrement.setOnAction((ActionEvent actionEvent) -> {
            parseText();
        ...
        btnDecrement.setOnAction((ActionEvent actionEvent) -> {
            parseText();
...
// 9/11/2014 - deprecated HBoxBuilder            
//        getChildren().add(HBoxBuilder.create().children(btnDecrement, textField, btnIncrement).build());
    ...
    /**
     * Parses the text and sets the
     * {@linkplain NumberSpinner#valueProperty() value} accordingly. If parsing
     * fails, the value is set to null.
     */
